...
class AdminEditServiceComponent extends Component
{
    ...
    public function updateService()
    {
        ...
        if ($this->newthumbnail) {
            app(ServiceAssetCleaner::class)->deleteFile('images/services/thumbnails', $service->thumbnail);
        ...
        if ($this->newimage) {
            app(ServiceAssetCleaner::class)->deleteFile('images/services', $service->image);
