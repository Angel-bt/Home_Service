<div>
    ...
    @else
        <div class="alert alert-danger" style="margin: 20px; padding: 10px; border-radius: 5px; background-color: #f8d7da; color: #721c24;">
            El servicio solicitado no está disponible. Por favor, intenta nuevamente.
